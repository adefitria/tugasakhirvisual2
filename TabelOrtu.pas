...
begin
if (Edit1.Text= '')or (Edit2.Text ='') or (Edit3.Text= '')or (Edit4.Text ='') or (Edit5.Text= '')or (Edit6.Text ='') or (c1.Text= '') or (Edit7.Text= '') or (c2.Text= '')then
begin
...
//simpan
zqry1.SQL.Clear;
zqry1.SQL.Add('insert into tabel_ortu values (null,"'+Edit1.Text+'","'+Edit2.Text+'","'+Edit3.Text+'","'+Edit4.Text+'","'+Edit5.Text+'","'+Edit6.Text+'","'+c1.Text+'","'+Edit7.Text+'","'+c2.Text+'")');
zqry1.ExecSQL;
...
if (Edit1.Text = zqry1.Fields[1].AsString) and (Edit2.Text = zqry1.Fields[2].AsString) and (Edit3.Text = zqry1.Fields[3].AsString) and (Edit4.Text = zqry1.Fields[4].AsString) and (Edit5.Text = zqry1.Fields[5].AsString) and (Edit6.Text = zqry1.Fields[6].AsString)and (c1.Text = zqry1.Fields[7].AsString) and (Edit7.Text = zqry1.Fields[8].AsString) and (c2.Text = zqry1.Fields[9].AsString) then
begin
...
zqry1.SQL.Clear;
zqry1.SQL.Add('Update tabel_ortu set nik= "'+Edit1.Text+'",nama="'+Edit2.Text+'",pendidikan="'+Edit3.Text+'",pekerjaan="'+Edit4.Text+'",telp="'+Edit5.Text+'",alamat="'+Edit6.Text+'",jenis_kelamin="'+c1.Text+'",agama="'+Edit7.Text+'",status="'+c2.Text+'" where id_ortu="'+id+'"');
zqry1. ExecSQL;
...
c2.Text:= zqry1.FieldList[9].AsString;
end;
